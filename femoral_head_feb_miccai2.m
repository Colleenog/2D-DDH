function [center_FH_new, radius_FH_new, quality_FH, quality_trirad] = femoral_head_feb_miccai2 (sps1,probability,map,radius_FH,center_FH,center_alpha_beta,alpha,beta,size_mm,im,m_F,c_F) 
...
% hough based circle fit
    ...
    %18 feb attempt
        radii = round(size_mm*7.5):1:size_mm*9;
